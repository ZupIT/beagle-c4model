At the second level, we showed in a more detailed way the system describing its containers (do not confuse with Docker) and how they communicate/interact.
